...
class AppVersion {
  ...
  static const List<UpdateEntry> updateHistory = [
    UpdateEntry(
      ...
      date: '2026-09-17',
      notes: [
        '任意の時間を入力しても、A〜Yの記号も併せて選べるようにしました（任意の時間を選んでも記号は消えなくなりました）',
        '任意の時間の画面で、「10分休憩あり・なし」を選べるようになりました',
        '任意の時間の画面の表示をシンプルにしました（時間帯の横の時間数表示を削除）',
        '月間シフト一覧表の黄色マスには合計時間数を表示し、タップすると開始・終了時刻と休憩有無の詳細が見られるようになりました',
      ],
    ),
    UpdateEntry(
      version: '2.2',
    ...
    UpdateEntry(
      ...
      date: '2026-09-01',
      notes: [
        '「入力日数・希望合計時間」などの一覧に「送信ステータス」を追加しました',
        '（送信済み／未送信／再提出〇回が、ひと目でわかるようになりました）',
      ],
    ),
    UpdateEntry(
      version: '1.9',
      date: '2026-09-01',
      notes: [
        '自分のシフトが送信済みかどうか、画面上部でひと目でわかるようになりました',
        '（「送信済み」「まだ送信されていません」の表示が自動で切り替わります）',
      ],
    ),
    UpdateEntry(
      version: '1.8',
